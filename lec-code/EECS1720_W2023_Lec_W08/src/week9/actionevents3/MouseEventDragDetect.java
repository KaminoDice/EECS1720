...
public class MouseEventDragDetect extends JFrame implements MouseListener {
	...
	public MouseEventDragDetect(String title) {
	...
	public static void main(String[] args) {
		...
		MouseEventDragDetect frame = new MouseEventDragDetect("MouseEvent Demo");
	...
	public void mousePressed(MouseEvent e) {
		...
		this.messageArea.append("Mouse pressed (# clicks = " + e.getClickCount() + "); " 
				...
				+ " user: (" + e.getX() + ", " + e.getY() + "); " 
				+ " screen: (" + e.getLocationOnScreen().getX() + ", " + e.getLocationOnScreen().getY() + ") .\n");
