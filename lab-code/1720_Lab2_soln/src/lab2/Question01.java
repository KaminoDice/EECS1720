...
public class Question01 {
	...
	public static String elapsedMins1(String userInput) {
		...
		output.println("tok1 = " + tok1);
		output.println("tok2 = " + tok2);
		...
		output.println("hrs = " + tok1);
		output.println("mins = " + tok2);
		...
		int minsElapsed = (hrs%TWELVE)*MINS_PER_HOUR + mins;
		
		output.println("minsElapsed = " + minsElapsed + "\n\n");
		
		String result = "" + minsElapsed;
		return result;
